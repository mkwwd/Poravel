...
const moveWrite = () => {
    if (userInfo.value === null) {
        ...
        router.push({ name: "qna-write", params: { article_type: articleType.value } });
    }
};
</script>
...
<template>
    <div class="info-area">
        ...
        <table class="info-main">
            ...
            <tbody>
                <QnaListItem v-for="article in articles" :key="article.article_no" :article="article"></QnaListItem>
            </tbody>
        </table>
        <div class="btn-area">
